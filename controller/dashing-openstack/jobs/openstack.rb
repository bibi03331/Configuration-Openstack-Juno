SCHEDULER.every '10s' do
  ...
  def get_tenant_data(id, neutron_quotas=false)
    ...
    cmd_get_limits = "/home/ubuntu/dashing-openstack/jobs/get_compute_limits.sh " + id
    ...
    cmd_get_quotas = "/home/ubuntu/dashing-openstack/jobs/get_compute_quotas.sh " + id
    ...
    cmd_get_quotas = "/home/ubuntu/dashing-openstack/jobs/get_storage_limits.sh " + id
    resp_data = `#{cmd_get_quotas}`
    resp = JSON.parse(resp_data)
  ...
  def get_hypervisor_data(id)
    ...
    cmd_get_hypervisor = "/home/ubuntu/dashing-openstack/jobs/get_compute_hypervisor.sh " + id
  ...
  cmd_get_tenants = "/home/ubuntu/dashing-openstack/jobs/get_compute_tenants.sh"
